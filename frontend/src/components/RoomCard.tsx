        ...
        <div>
            {
                ...
                <div className="absolute bottom-10 left-full translate-x-4 bg-white shadow-xl p-5 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 w-48">
