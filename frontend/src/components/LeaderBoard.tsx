...
const RankHourPrice: React.FC<RankItemHourProps> = ({ rank, name, hour }) => (
    <div className="flex items-center justify-between px-4 py-3 bg-white rounded-3xl w-[90%] m-3">
      <div className="flex items-center space-x-10">
        <div className="ml-5">{rank}</div>
        <div>{name}</div>
...
function LeaderBoard() {
  ...
  const rankDataHour: RankItemHourProps[] = [
    {rank: 1, name: "Item 1", hour: "10 hours"},
    {rank: 2, name: "Item 2", hour: "20 hours"},
    {rank: 3, name: "Item 3", hour: "30 hours"},
    {rank: 4, name: "Item 4", hour: "40 hours"},
    {rank: 5, name: "Item 5", hour: "50 hours"},
  ];
  ...
  return (
    ...
    <div className="flex flex-col px-12 pt-6 pb-10 mt-20 max-w-full bg-white rounded-3xl w-[80%] max-md:px-5 max-md:mt-10">
      <header className="flex gap-5 justify-between self-center max-w-full w-[307px]">
        ...
        <div className={`${tranclass1}`} onClick={() => {setMenuChanger(1)}}>
          <img
            loading="lazy"
        ...
        <div className={`${tranclass2}`} onClick={() => {setMenuChanger(2)}}>
        <img
          loading="lazy"
